...
namespace Models.ProxyClasses
{
	...
	public partial class Lead : BaseProxyClass
	{
		...
		///<summary>
		///<para>Logical Name: ifb_dsmname</para>
		///<para>Max Length: 100 characters</para>
		///</summary>
		[AttributeLogicalNameAttribute("ifb_dsmname")]
		public string Ifb_DSMName
		{
			get { return this.GetPropertyValue<string>("ifb_dsmname"); }
		}
		///<summary>
		...
		///<summary>
		///<para>Logical Name: ifb_dsmyominame</para>
		///<para>Max Length: 100 characters</para>
		///</summary>
		[AttributeLogicalNameAttribute("ifb_dsmyominame")]
		public string Ifb_DSMYomiName
		{
			get { return this.GetPropertyValue<string>("ifb_dsmyominame"); }
		}
		///<summary>
		...
		public int? Age
		{
			...
			set { this.SetPropertyValue("cdi_age", (int?)value, (int)-2147483648, (int)2147483647, "Age"); }
		}
		///<summary>
		///<para>Logical Name: ifb_agencycode</para>
		///<para>Max Length: 50 characters</para>
		///</summary>
		[AttributeLogicalNameAttribute("ifb_agencycode")]
		public string AgencyCode
		{
			get { return this.GetPropertyValue<string>("ifb_agencycode"); }
			set { this.SetPropertyValue("ifb_agencycode", value, 50, "AgencyCode"); }
		}
		///<summary>
		...
		///<summary>
		///<para>Logical Name: new_christest</para>
		///<para>Max Length: 100 characters</para>
		///</summary>
		[AttributeLogicalNameAttribute("new_christest")]
		public string ChrisAdamsTest
		{
			get { return this.GetPropertyValue<string>("new_christest"); }
			set { this.SetPropertyValue("new_christest", value, 100, "ChrisAdamsTest"); }
		}
		///<summary>
		...
		public EntityReference Client
		{
			...
			set { this.SetPropertyValue<EntityReference>("customerid", value, "Client"); }
		}
		///<summary>
		...
		public string DatabaseName
		{
			...
			set { this.SetPropertyValue("sgcom_databasename", value, 100, "DatabaseName"); }
		}
		///<summary>
		...
		///<summary>
		///<para>Logical Name: ifb_dsm</para>
		///</summary>
		[AttributeLogicalNameAttribute("ifb_dsm")]
		public EntityReference DSM
		{
			get { return this.GetPropertyValue<EntityReference>("ifb_dsm"); }
			set { this.SetPropertyValue<EntityReference>("ifb_dsm", value, "DSM"); }
		}
		///<summary>
		...
		///<summary>
		///<para>Logical Name: ifb_employeeid</para>
		///<para>Max Length: 10 characters</para>
		///</summary>
		[AttributeLogicalNameAttribute("ifb_employeeid")]
		public string EmployeeID
		{
			get { return this.GetPropertyValue<string>("ifb_employeeid"); }
			set { this.SetPropertyValue("ifb_employeeid", value, 10, "EmployeeID"); }
		}
		///<summary>
		...
		public Guid LeadId
		{
			...
			{
				base.Id = value;
				base.SetPropertyValue("leadid", value, "LeadId");
			}
		}
		///<summary>
		///<para>Logical Name: ifb_leadscore</para>
		///<para>Max Length: 100 characters</para>
		///</summary>
		[AttributeLogicalNameAttribute("ifb_leadscore")]
		public string LeadScore
		{
			get { return this.GetPropertyValue<string>("ifb_leadscore"); }
			set { this.SetPropertyValue("ifb_leadscore", value, 100, "LeadScore"); }
		}
		/// <summary>
		...
		public string RecordID
		{
			...
			set { this.SetPropertyValue("sgcom_recordid", value, 100, "RecordID"); }
		}
		///<summary>
		...
		///<summary>
		///<para>Logical Name: ifb_terminationdate</para>
		///</summary>
		[AttributeLogicalNameAttribute("ifb_terminationdate")]
		public DateTime? TerminationDate
		{
			get { return this.GetPropertyValue<DateTime?>("ifb_terminationdate"); }
			set { this.SetPropertyValue<DateTime?>("ifb_terminationdate", value, "TerminationDate"); }
		}
		///<summary>
		...
		public string Title
		{
			...
			set { this.SetPropertyValue("ifb_title", value, 128, "Title"); }
		}
		///<summary>
		...
		public int? TotalScore
		{
			...
			set { this.SetPropertyValue("cdi_totalscore", (int?)value, (int)-2147483648, (int)2147483647, "TotalScore"); }
		}
		///<summary>
		...
		/// <summary>
		///Logical Name: ifb_type
		/// </summary>
		[AttributeLogicalNameAttribute("ifb_type")]
		public eType? Type
		{
			get
			{
		...
		///<summary>
		///<para>Logical Name: ifb_type</para>
		///</summary>
		[AttributeLogicalNameAttribute("ifb_type")]
		public OptionSetValue Type_OptionSetValue
		{
			get { return this.GetPropertyValue<OptionSetValue>("ifb_type"); }
			set { this.SetPropertyValue<OptionSetValue>("ifb_type", value, "Type_OptionSetValue"); }
		}
		/// <summary>
		/// Retrieves the current value's text in the user's language.
		/// </summary>
		...
		{
			return this.Type_OptionSetValue.GetOptionSetText(Service, this, "ifb_type");
		}
		/// <summary>
		/// Retrieves the current value's text in the user's language.
		/// </summary>
		...
		///<summary>
		///<para>Logical Name: ifb_userid</para>
		///<para>Max Length: 100 characters</para>
		///</summary>
		[AttributeLogicalNameAttribute("ifb_userid")]
		public string UserID
		{
			get { return this.GetPropertyValue<string>("ifb_userid"); }
			set { this.SetPropertyValue("ifb_userid", value, 100, "UserID"); }
		}
		///<summary>
		...
		/// </summary>
		public List<Entity> GetClientAccounts(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "account", "originatingleadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: account_originating_lead</para>
		/// </summary>
		public List<Entity> GetClientAccounts(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "account", "originatingleadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		...
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_anonymousvisitor</para>
		/// </summary>
		public List<Entity> GetAnonymousVisitors(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_anonymousvisitor", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_anonymousvisitor</para>
		/// </summary>
		public List<Entity> GetAnonymousVisitors(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_anonymousvisitor", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_emailevent</para>
		/// </summary>
		public List<Entity> GetEmailEvents(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_emailevent", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_emailevent</para>
		/// </summary>
		public List<Entity> GetEmailEvents(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_emailevent", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_eventparticipation_Lead</para>
		/// </summary>
		public List<Entity> GetEventParticipations(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_eventparticipation", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_eventparticipation_Lead</para>
		/// </summary>
		public List<Entity> GetEventParticipations(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_eventparticipation", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_excludedemail</para>
		/// </summary>
		public List<Entity> GetExcludedRecipients(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_excludedemail", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_excludedemail</para>
		/// </summary>
		public List<Entity> GetExcludedRecipients(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_excludedemail", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_importlog_Lead</para>
		/// </summary>
		public List<Entity> GetImportLogs(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_importlog", "cdi_lead", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_importlog_Lead</para>
		/// </summary>
		public List<Entity> GetImportLogs(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_importlog", "cdi_lead", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_pageview</para>
		/// </summary>
		public List<Entity> GetPageViews(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_pageview", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_pageview</para>
		/// </summary>
		public List<Entity> GetPageViews(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_pageview", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_postedfield</para>
		/// </summary>
		public List<Entity> GetPostedFields(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_postedfield", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_postedfield</para>
		/// </summary>
		public List<Entity> GetPostedFields(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_postedfield", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_postedform</para>
		/// </summary>
		public List<Entity> GetPostedForms(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_postedform", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_postedform</para>
		/// </summary>
		public List<Entity> GetPostedForms(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_postedform", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_postedsubscription</para>
		/// </summary>
		public List<Entity> GetPostedSubscriptions(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_postedsubscription", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_postedsubscription</para>
		/// </summary>
		public List<Entity> GetPostedSubscriptions(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_postedsubscription", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_postedsurvey</para>
		/// </summary>
		public List<Entity> GetPostedSurveys(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_postedsurvey", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_postedsurvey</para>
		/// </summary>
		public List<Entity> GetPostedSurveys(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_postedsurvey", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_sendemail</para>
		/// </summary>
		public List<Entity> GetSendClickDimensionsEmails(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_sendemail", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_sendemail</para>
		/// </summary>
		public List<Entity> GetSendClickDimensionsEmails(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_sendemail", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_sentemail</para>
		/// </summary>
		public List<Entity> GetSentEmails(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_sentemail", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_sentemail</para>
		/// </summary>
		public List<Entity> GetSentEmails(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_sentemail", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_socialclick_lead</para>
		/// </summary>
		public List<Entity> GetSocialClicks(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_socialclick", "cdi_lead", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_socialclick_lead</para>
		/// </summary>
		public List<Entity> GetSocialClicks(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_socialclick", "cdi_lead", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_subscriptionpreference</para>
		/// </summary>
		public List<Entity> GetPostedPreferences(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_subscriptionpreference", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_subscriptionpreference</para>
		/// </summary>
		public List<Entity> GetPostedPreferences(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_subscriptionpreference", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_surveyanswer</para>
		/// </summary>
		public List<Entity> GetSurveyAnswers(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_surveyanswer", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_surveyanswer</para>
		/// </summary>
		public List<Entity> GetSurveyAnswers(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_surveyanswer", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: lead_cdi_txtmessages</para>
		/// </summary>
		...
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_unsubscribe</para>
		/// </summary>
		public List<Entity> GetUnsubscribes(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_unsubscribe", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_unsubscribe</para>
		/// </summary>
		public List<Entity> GetUnsubscribes(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_unsubscribe", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_visit</para>
		/// </summary>
		public List<Entity> GetVisits(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_visit", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: cdi_lead_cdi_visit</para>
		/// </summary>
		public List<Entity> GetVisits(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "cdi_visit", "cdi_leadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		...
		/// <summary>
		/// <para><b>Client (Originating Lead)</b></para>
		/// <para>Schema Name: contact_originating_lead</para>
		/// </summary>
		public List<Client> GetClients_OriginatingLead(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Client>(Service, this.Id, "contact", "originatingleadid", Columns); }
		/// <summary>
		/// <para><b>Client (Originating Lead)</b></para>
		/// <para>Schema Name: contact_originating_lead</para>
		/// </summary>
		public List<Client> GetClients_OriginatingLead(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<Client>(Service, this.Id, "contact", "originatingleadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		...
		/// <summary>
		/// <para><b>ClientDemographics (Lead)</b></para>
		/// <para>Schema Name: ifb_lead_ifb_clientdemographics_Lead</para>
		/// </summary>
		public List<ClientDemographics> GetClientDemographics_Lead(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ClientDemographics>(Service, this.Id, "ifb_clientdemographics", "ifb_lead", Columns); }
		/// <summary>
		/// <para><b>ClientDemographics (Lead)</b></para>
		/// <para>Schema Name: ifb_lead_ifb_clientdemographics_Lead</para>
		/// </summary>
		public List<ClientDemographics> GetClientDemographics_Lead(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities<ClientDemographics>(Service, this.Id, "ifb_clientdemographics", "ifb_lead", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: lead_ifb_externalsystemactions</para>
		/// </summary>
		...
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: lead_ifb_processmovementhistories</para>
		/// </summary>
		...
		/// </summary>
		public List<Entity> GetLeadAddresses(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "leadaddress", "parentid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: lead_addresses</para>
		/// </summary>
		public List<Entity> GetLeadAddresses(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "leadaddress", "parentid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		...
		/// </summary>
		public List<Entity> GetSalesOpportunities(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "opportunity", "originatingleadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		/// <para>Schema Name: opportunity_originating_lead</para>
		/// </summary>
		public List<Entity> GetSalesOpportunities(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedOneToManyEntities(Service, this.Id, "opportunity", "originatingleadid", Columns); }
		/// <summary>
		/// <para><b>Entity ()</b></para>
		...
		/// <summary>
		/// <para>Related Entity: <b>Client Account</b></para>
		/// <para>N:N Relationship</para>
		/// <para>Schema Name: accountleads_association</para>
		/// </summary>
		public List<Entity> GetClientAccounts2(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities(Service, this, "lead", "leadid", "account", "accountid", "accountleads", "leadid", "accountid", Columns); }
		public List<Entity> GetClientAccounts2(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities(Service, this, "lead", "leadid", "account", "accountid", "accountleads", "leadid", "accountid", Columns); }
		public void RelateClientAccounts(IOrganizationService Service, params Entity[] Items) { Service.RelateEntities(this, "accountleads_association", Items); }
		public void RelateClientAccounts(IOrganizationService Service, params EntityReference[] Items) { Service.RelateEntities(this, "accountleads_association", Items); }
		public void UnRelateClientAccounts(IOrganizationService Service, params Entity[] Items) { Service.UnRelateEntities(this, "accountleads_association", Items); }
		public void UnRelateClientAccounts(IOrganizationService Service, params EntityReference[] Items) { Service.UnRelateEntities(this, "accountleads_association", Items); }
		/// <summary>
		/// <para>Related Entity: <b>Email Send</b></para>
		/// <para>N:N Relationship</para>
		/// <para>Schema Name: cdi_emailsend_lead</para>
		/// </summary>
		public List<Entity> GetEmailSends(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities(Service, this, "lead", "leadid", "cdi_emailsend", "cdi_emailsendid", "cdi_emailsend_lead", "leadid", "cdi_emailsendid", Columns); }
		public List<Entity> GetEmailSends(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities(Service, this, "lead", "leadid", "cdi_emailsend", "cdi_emailsendid", "cdi_emailsend_lead", "leadid", "cdi_emailsendid", Columns); }
		public void RelateEmailSends(IOrganizationService Service, params Entity[] Items) { Service.RelateEntities(this, "cdi_emailsend_lead", Items); }
		public void RelateEmailSends(IOrganizationService Service, params EntityReference[] Items) { Service.RelateEntities(this, "cdi_emailsend_lead", Items); }
		public void UnRelateEmailSends(IOrganizationService Service, params Entity[] Items) { Service.UnRelateEntities(this, "cdi_emailsend_lead", Items); }
		public void UnRelateEmailSends(IOrganizationService Service, params EntityReference[] Items) { Service.UnRelateEntities(this, "cdi_emailsend_lead", Items); }
		/// <summary>
		/// <para>Related Entity: <b>Client</b></para>
		/// <para>N:N Relationship</para>
		/// <para>Schema Name: contactleads_association</para>
		/// </summary>
		public List<Client> GetClients(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<Client>(Service, this, "lead", "leadid", "contact", "contactid", "contactleads", "leadid", "contactid", Columns); }
		public List<Client> GetClients(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities<Client>(Service, this, "lead", "leadid", "contact", "contactid", "contactleads", "leadid", "contactid", Columns); }
		public void RelateClients(IOrganizationService Service, params Entity[] Items) { Service.RelateEntities(this, "contactleads_association", Items); }
		public void RelateClients(IOrganizationService Service, params EntityReference[] Items) { Service.RelateEntities(this, "contactleads_association", Items); }
		public void UnRelateClients(IOrganizationService Service, params Entity[] Items) { Service.UnRelateEntities(this, "contactleads_association", Items); }
		public void UnRelateClients(IOrganizationService Service, params EntityReference[] Items) { Service.UnRelateEntities(this, "contactleads_association", Items); }
		/// <summary>
		/// <para>Related Entity: <b>Product</b></para>
		/// <para>N:N Relationship</para>
		/// <para>Schema Name: leadproduct_association</para>
		/// </summary>
		public List<Entity> GetProducts(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities(Service, this, "lead", "leadid", "product", "productid", "leadproduct", "leadid", "productid", Columns); }
		public List<Entity> GetProducts(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities(Service, this, "lead", "leadid", "product", "productid", "leadproduct", "leadid", "productid", Columns); }
		...
		/// </summary>
		public List<Entity> GetCompetitors(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities(Service, this, "lead", "leadid", "competitor", "competitorid", "leadcompetitors", "leadid", "competitorid", Columns); }
		public List<Entity> GetCompetitors(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities(Service, this, "lead", "leadid", "competitor", "competitorid", "leadcompetitors", "leadid", "competitorid", Columns); }
		...
		/// </summary>
		public List<Entity> GetMarketingLists(IOrganizationService Service, params string[] Columns) { return BaseProxyClass.GetRelatedManyToManyEntities(Service, this, "lead", "leadid", "list", "listid", "listmember", "entityid", "listid", Columns); }
		public List<Entity> GetMarketingLists(IOrganizationService Service, ColumnSet Columns) { return BaseProxyClass.GetRelatedManyToManyEntities(Service, this, "lead", "leadid", "list", "listid", "listmember", "entityid", "listid", Columns); }
		...
		{
			///<summary><para>Agent Recruit</para>
			///<para>Value = 225090000</para></summary>
			[Description("Agent Recruit")]
			AgentRecruit = 225090000,
		...
		public static class Properties
		{
			...
			/// <summary><para>ifb_dsmname</para>
			/// <para>ifb_dsmname</para></summary>
			public const string Ifb_DSMName = "ifb_dsmname";
			...
			/// <summary><para>ifb_dsmyominame</para>
			/// <para>ifb_dsmyominame</para></summary>
			public const string Ifb_DSMYomiName = "ifb_dsmyominame";
			...
			public const string Age = "cdi_age";
			/// <summary><para>Agency Code</para>
			/// <para>ifb_agencycode</para></summary>
			public const string AgencyCode = "ifb_agencycode";
			...
			/// <summary><para>Chris Adams Test</para>
			/// <para>new_christest</para></summary>
			public const string ChrisAdamsTest = "new_christest";
			...
			public const string Client = "customerid";
			...
			/// <summary><para>Database Name</para>
			/// <para>sgcom_databasename</para></summary>
			public const string DatabaseName = "sgcom_databasename";
			...
			/// <summary><para>DSM</para>
			/// <para>ifb_dsm</para></summary>
			public const string DSM = "ifb_dsm";
			/// <summary><para>Email</para>
			...
			/// <summary><para>Employee ID</para>
			/// <para>ifb_employeeid</para></summary>
			public const string EmployeeID = "ifb_employeeid";
			...
			/// <summary><para>Lead Score</para>
			/// <para>ifb_leadscore</para></summary>
			public const string LeadScore = "ifb_leadscore";
			...
			public const string RecordID = "sgcom_recordid";
			...
			/// <summary><para>Termination Date</para>
			/// <para>ifb_terminationdate</para></summary>
			public const string TerminationDate = "ifb_terminationdate";
			...
			public const string TotalScore = "cdi_totalscore";
			...
			/// <para>ifb_type</para></summary>
			public const string Type = "ifb_type";
			/// <summary><para>User ID</para>
			/// <para>ifb_userid</para></summary>
			public const string UserID = "ifb_userid";
